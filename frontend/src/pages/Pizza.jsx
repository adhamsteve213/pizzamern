...
import pizza from '../assets/cards/pizza.js';
...
const Pizza = () => {
  ...
  return (
    <div>
      <h1 style={{color: 'red', textAlign: 'center', marginTop: '20px', marginBottom: '20px'}}>Pizza Menu</h1>
      <p style={{color: 'red', textAlign: 'center', marginTop: '20px', marginBottom: '20px'}}>Choose from our variety of pizzas!</p>
