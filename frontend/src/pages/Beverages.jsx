...
import side from '../assets/cards/side.js';
...
const Beverages = () => {
  ...
  return (
    <div>
      <h1 style={{color: 'red', textAlign: 'center', marginTop: '20px', marginBottom: '20px'}} >Beverages</h1>
      <p style={{color: 'red', textAlign: 'center', marginTop: '20px', marginBottom: '20px'}} >Refresh yourself with our drinks!</p>
